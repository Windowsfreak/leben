...
function loadMore() {
    ...
    const url = `/api/tiles?q=${encodeURIComponent(q)}&lang=${lang}&offset=${offset}&limit=${limit}`;
...
function toggleLightboxInfoPanel() {
    ...
    fetch(`/api/tiles/${encodeURIComponent(activeLightboxTile.name)}/versions`, { headers: buildApiHeaders() })
        .then(res => res.json())
        .then(res => {
